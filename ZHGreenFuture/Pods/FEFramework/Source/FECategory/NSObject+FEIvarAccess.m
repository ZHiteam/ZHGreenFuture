//
//  NSObject+FEIvarAccess.m
//  FETestRuntimeGetVar
//
//  Created by xxx on 14-2-28.
...
@interface FEIvarInfo(){
	NSString * name;
	NSString * typeEncoding;
}
@end

@implementation FEIvarInfo
...
+ (FEIvarInfo *)ivarInfoWithName:(NSString *)aName type:(NSString *)aType{
	FEIvarInfo * obj = [[FEIvarInfo alloc] initWithName:aName type:aType];
#if !__has_feature(objc_arc)
...
#pragma mark ///////////////////////////////////////////////////
@implementation NSObject (FEIvarAccess)
...
- (NSArray *)getIvars {
	...
	for (unsigned int i = 0; i < count; i++) {
		...
		[infoObjects addObject:[FEIvarInfo ivarInfoWithName:name type:type]];
	}
