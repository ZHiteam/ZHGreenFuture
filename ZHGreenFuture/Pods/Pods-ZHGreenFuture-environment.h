...
// FEFramework
#define COCOAPODS_POD_AVAILABLE_FEFramework
#define COCOAPODS_VERSION_MAJOR_FEFramework 0
#define COCOAPODS_VERSION_MINOR_FEFramework 0
#define COCOAPODS_VERSION_PATCH_FEFramework 1
