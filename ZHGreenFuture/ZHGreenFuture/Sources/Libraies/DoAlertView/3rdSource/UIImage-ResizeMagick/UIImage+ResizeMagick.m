...
- (UIImage *) resizedImageByMagick: (NSString *) spec
{
    ...
    if([spec hasSuffix:@"!"]) {
        ...
        NSUInteger width = (NSInteger)[[widthAndHeight objectAtIndex: 0] floatValue];
        NSUInteger height = (NSInteger)[[widthAndHeight objectAtIndex: 1] floatValue];
    ...
    if ([widthAndHeight count] == 1) {
        return [self resizedImageByWidth: (NSInteger)[spec longLongValue]];
    }
    if ([[widthAndHeight objectAtIndex: 0] isEqualToString: @""]) {
        return [self resizedImageByHeight: (NSInteger)[[widthAndHeight objectAtIndex: 1] longLongValue]];
    }
