...
@interface ZHZbarPrivateVC ()<AVCaptureMetadataOutputObjectsDelegate>
{
    NSInteger num;
    BOOL  upOrdown;
    NSTimer *timer;
...
@implementation ZHZbarPrivateVC
...
- (void)viewDidLoad
{
    ...
    timer = [NSTimer scheduledTimerWithTimeInterval:.02 target:self selector:@selector(moveLineAnimation) userInfo:nil repeats:YES];
}
